-- Deal 20: Sony PlayStation 5 Slim 1TB + Call of Duty: Black Ops 6 Bundle (TOUCH, уцінка)
-- Run in Supabase SQL Editor (paste this entire file, not the path).
-- Safe to re-run (updates deal 20 if it already exists).
...
WITH deal AS (
  SELECT
    'https://wbbsv.com/g/ynys1f2mjpd66b47c3060e81904d8b/?ulp=https%3A%2F%2Ftouch.com.ua%2Fua%2Fitem%2Figrovaya-konsol-sony-playstation-5-slim-1tb-call-of-duty-black-ops-6-bundle-1000049595-utsenka168364%2F' AS affiliate_url
)
