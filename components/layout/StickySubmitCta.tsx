...
export function StickySubmitCta() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-border/40 bg-card/98 p-3 shadow-[0_-4px_24px_rgba(15,23,42,0.08)] backdrop-blur-md md:hidden">
